...
const GUEST_NOTIFICATIONS: Notification[] = [
  {
    ...
    time: 'just now',
    message: 'Upload an image and the backend will call the DebackX worker for OCR, translation, and rendering.',
    accent: 'violet',
    type: 'generated',
  },
  {
    ...
    title: 'Gateway mode',
    time: '2h ago',
    message: 'VieTrans now stays CPU-friendly by forwarding heavy inference to the configured worker URL.',
    detail: 'Set IIMT_WORKER_URL in the backend environment.',
    accent: 'gold',
    type: 'generated',
  },
  {
    ...
    time: '1d ago',
    message: 'Use the thesis report metrics for BLEU, chrF, OCR CER/WER, latency, RAM, and throughput.',
    accent: 'green',
    type: 'generated',
  },
];
